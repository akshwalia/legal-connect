...
const leftContainerStyle = {
    backgroundImage: 'url(src/assets/images/serviceSignUpBackground.jpg)',
}
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.leftcontainer} style={leftContainerStyle}>
                ...
                <div className={styles.welcome} style={{color: 'black'}}>
                    <h1 className={styles.welcometext}>Join Us Today!</h1>
                    <p>Get registered as a service provider.</p>
                </div>
            </div>
